  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      if (currentDirectory === "scripts") {
        addLine("visitor@apescasio.fr/cli:~/scripts$ " + command.innerHTML, "no-animation", 0);
      } else {
        addLine("visitor@apescasio.fr/cli:~$ " + command.innerHTML, "no-animation", 0);
      }
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "fr":
      ...
      setTimeout(function () {
        window.location.href = 'https://apescasio.fr/clifr';
      }, 1000);
      break;
    case "social":
    ...
    case "cd scripts":
      ...
      sheet1.addRule('#liner::before', 'content: "visitor@apescasio.fr/cli:~/scripts$"');
      break;
    case "cd ./scripts":
      currentDirectory = "scripts";
      const sheet2 = document.styleSheets[0];
      sheet2.addRule('#liner::before', 'content: "visitor@apescasio.fr/cli:~/scripts$"');
      break;
    case "cd ..":
      currentDirectory = "";
      const sheet3 = document.styleSheets[0];
      sheet3.addRule('#liner::before', 'content: "visitor@apescasio.fr/cli:~$"');
      break;
    case "cd":
      currentDirectory = "";
      const sheet4 = document.styleSheets[0];
      sheet4.addRule('#liner::before', 'content: "visitor@apescasio.fr/cli:~$"');
      break;
    case "cd /home/visitor/scripts":
      currentDirectory = "scripts";
      const sheet5 = document.styleSheets[0];
      sheet5.addRule('#liner::before', 'content: "visitor@apescasio.fr/cli:~/scripts$"');
      break;
